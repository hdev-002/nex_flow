    ...
    <div class="card card-flush pt-1 mb-5 mb-lg-10">
        ...
        <div class="card-header mb-5">
            ...
            <h3 class="card-title">
                ...
                <div class="text-secondary-emphasis" wire:loading.remove>
                    @if ($saved)
                        <i class="ki-outline ki-cloud fs-5"></i> Saved
                    @endif
                </div>
            </h3>
        ...
        <div class="card-body pt-0">
            ...
            <form wire:ignore.self>
                ...
                <div class="d-flex flex-column px-5 px-lg-10">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" id="name" wire:model.defer="name" class="form-control" placeholder="Student name">
                            <!--end::Input-->
                        ...
                        <div class="col-12 col-md-3 mb-3" wire:ignore>
                            ...
                            <livewire:data-select2
                                ...
                                valueField="id"
                                labelField="name_mm"
                                :defaultSelected="$student_nrc_code"
                            />
                        ...
                        <div class="col-12 col-md-3 mb-3">
                            ...
                            <input type="number" id="student_nrc_no" wire:model.defer="student_nrc_no" class="form-control" placeholder="NRC No">
                        ...
                        <div class="col-12 col-md-4 mb-3">
                            ...
                            <input type="text" wire:model.defer="grade_10_desk_id" class="form-control" placeholder="Desk ID">
                        ...
                        <div class="col-12 col-md-4 mb-3">
                            ...
                            <input type="number" wire:model.defer="grade_10_total_mark" class="form-control @error('grade_10_total_mark') is-invalid @enderror" placeholder="Total Mark" min="240"  max="600">
                        ...
                        <div class="col-12 col-md-4 mb-3">
                            ...
                            <input type="number" wire:model.defer="grade_10_passed_year" class="form-control @error('grade_10_passed_year') is-invalid @enderror" placeholder="Passed Year" min="1900" max="2100">
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <input type="text" wire:model.defer="father_name" class="form-control" placeholder="Father's Name">
                        ...
                        <div class="col-12 col-md-3 mb-3">
                            ...
                            <livewire:data-select2
                                ...
                                valueField="id"
                                labelField="name_mm"
                                :defaultSelected="$father_nrc_code"
                                wire:model.defer="father_nrc_code"
                                wire:key="father"
                            />
                        ...
                        <div class="col-12 col-md-3 mb-3">
                            ...
                            <input type="text" wire:model.defer="father_nrc_no" class="form-control @error('father_nrc_no') is-invalid @enderror" placeholder="NRC No">
                        ...
                        <div class="col-12 col-md-3 mb-3">
                            ...
                            <livewire:data-select2
                                ...
                                valueField="id"
                                labelField="name_mm"
                                :defaultSelected="$mother_nrc_code"
                                wire:model.defer="mother_nrc_code"
                                wire:key="mother"
                            />
                        ...
                        <div class="col-12 col-md-3 mb-3">
                            ...
                            <input type="text" wire:model.defer="mother_nrc_no" class="form-control @error('mother_nrc_no') is-invalid @enderror" placeholder="NRC No">
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <input type="tel" wire:model.defer="student_phone" id="student_phone" class="form-control @error('student_phone') is-invalid @enderror" placeholder="Student Phone">
                            @error('student_phone')<div class="text-danger">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-12 col-md-6 mb-3">
                            <label class="fw-semibold fs-6 mb-2">Parent Phone</label>
                            <input type="text" wire:model.defer="parent_phone" id="parent_phone" class="form-control @error('student_phone') is-invalid @enderror" placeholder="Parent Phone">
                            @error('parent_phone')<div class="text-danger">{{ $message }}</div>@enderror
                        </div>

                        <div class="col-12 mb-3">
                            <label class="fw-semibold fs-6 mb-2">Address</label>
                            <textarea wire:model.defer="address" class="form-control" placeholder="Address"></textarea>
                        ...
                        @if($for != 'major-registration')
                            <div class="col-12 mb-3">
                                <div class="form-check">
                                    <input @checked($is_major_registered) wire:model="is_major_registered" wire:click="$refresh" class="form-check-input" type="checkbox" id="flexCheckDefault" />
                        ...
                        @if($is_major_registered || $for == 'major-registration')
                            <!-- Additional Information -->
                            <div class="col-12 col-md-6 mb-3">
                                <label class="fw-semibold fs-6 mb-2">Approval No</label>
                                <input type="text" wire:model.defer="approval_no" class="form-control" placeholder="Approval No">
                                @error('approval_no')<div class="text-danger">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-12 col-md-6 mb-3">
                                <label class="fw-semibold fs-6 mb-2">AR WA THA No</label>
                                <input type="text" wire:model.defer="ar_wa_tha_no" class="form-control" placeholder="AR WA THA No">
                ...
                <!--begin::Actions-->
                <div class="text-center pt-10">
                    <button type="button" class="btn btn-light me-3" wire:click="discardChanges" >Discard</button>


                    <button type="button" class="btn btn-primary" wire:click="updateStudent" wire:loading.attr="disabled">
                        <span class="indicator-label">Update</span>
                        <span class="indicator-progress" wire:loading wire:targe="updateStudent">Please wait...
                																			<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                    </button>
                </div>
                <!--end::Actions-->
