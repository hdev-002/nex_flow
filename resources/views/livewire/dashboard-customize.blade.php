                    ...
                    <tbody>
                        @foreach($widgets as $widget)
                            <tr wire:sortable.item="{{ $widget['id'] }}" wire:key="widget-{{ $widget['id'] }}">
                                <td wire:sortable.handle style="cursor: move">
                                ...
                                <td class="text-end">
                                    <button type="button" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                        wire:click="startEditing({{ $widget['id'] }})">
                    ...
                    <form wire:submit.prevent="saveWidget">
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('editingWidget.title') is-invalid @enderror" 
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('editingWidget.value_type') is-invalid @enderror" 
