                ...
                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                    ...
                    <tbody>
                        @foreach($items as $item)
                            <tr wire:sortable.item="{{ $item->id }}" wire:key="nav-{{ $item->id }}">
                                <td wire:sortable.handle class="cursor-move">
                                    <i class="ki-duotone ki-dots-square fs-3"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i>
                                </td>
                                <td>{{ $item->title }}</td>
                ...
                <form wire:submit.prevent="saveItem">
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" wire:model="route_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Enter route name"/>
                            @error('route_name') <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="fv-row mb-7">
                            <label class="fw-semibold fs-6 mb-2">Icon Class</label>
                            <input type="text" wire:model="icon" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Enter icon class"/>
