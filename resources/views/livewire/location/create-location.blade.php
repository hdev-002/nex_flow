<div>
    <div class="d-flex align-items-center justify-content-between mb-3">
        <span class="d-flex align-items-center"><a href="{{ route('locations.list') }}" class="btn btn-icon btn-custom w-35px h-35px w-md-40px h-md-40px btn-active-light-secondary"><i class="fa-solid fa-arrow-left"></i></a><span class="fw-bolder fs-2 ms-2">Location</span></span>
    ...
    <form>
                    ...
                    <div class="row">
                        ...
                        <div class="fv-row col-12 col-md-6 mb-7 fv-plugins-icon-container">
                            ...
                            <div class="form-check mt-10">
                                <input wire:model.lazy="status" wire:click="$refresh" class="form-check-input" type="checkbox" id="flexCheckDefault" />
        ...
        <div class="text-start">
            ...
            <button type="button" class="btn btn-sm btn-dark" wire:click="create">
                <span class="indicator-label">Save</span>
                <span class="indicator-progress" wire:target="create" wire:loading>Saving...
