    ...
    <div>
        ...
        <div class="card w-md-800px w-lg-1000px shadow-none border-1 border-gray-400">
            ...
            <div class="card-body pt-1 pb-5 px-5">
                <!--begin::Table-->
                <div id="kt_table_users_wrapper" class="dt-container dt-bootstrap5 dt-empty-footer"><div id="" class="table-responsive"><table class="table align-middle fs-6 gy-5 dataTable" id="kt_table_users" style="width: 1094.5px;">
                            <thead>
                            <tr class="fw-semibold fs-6 text-gray-800 border-bottom-1 border-gray-300" role="row">
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                <tr class="">
                                    ...
                                    <td class="d-flex align-items-center px-0 py-1">
                                        <!--begin:: Avatar -->
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">Paing Soe Ko</a>
                                            <span>example.com</span>
                                        </div>
                                        <!--begin::User details-->
                                    </td>
                                    <td class="px-0 py-1">Admin</td>
                                    <td class="px-0 py-1">ssss</td>
                                    <td class="text-end px-0 py-1">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <button  class="menu-link px-3 btn btn-sm w-100">Delete</button>
                                            </div>
                                            <!--end::Menu item-->
                                        </div>
                                        <!--end::Menu-->
